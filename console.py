...
class Console:
    ...
    def pop_style(self)->Style:
        ...
        This will revert to the style applied prior to the corresponding 'push style' 
        
        Returns:
            Style:The previous applied style"""
    ...
    def _check_buffer(self)->None:
        """check if the buffer maybe rendered. """
    ...
    def _render_buffer(self)->str:
        """Render buffered output , and clean buffer. """
        output:List[str]=[]
